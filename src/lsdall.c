...
static double liter(double info[][50], double sufficient[][2], double bound[], int SorC[], int nsample[], double sample[], int accuracy, int *itrouble);
...
static void intnum2(double x1, double x2, double qolint[][50 +1], double shift[], double info[][50], int n1, int n2, int what);
static void intnum3(double x, double qolint[][50 +1], double d1, double e1, int vs, double bd, double shift[], double info[][50], int n1, int n2, int what);
static void intnum4(double x, double qolint[][50 +1], double d1, double e1, int vs, double bd, double shift[], double info[][50], int n1, int n2, int what);
